# Telprom Security - IT Solutions & Cybersecurity
...
## 🚀 Open Source projekti | Open Source Projects

Ta GitHub organizacija vsebuje naše open source projekte in orodja za:

This GitHub organization contains our open source projects and tools for:

### [AdminPanel](https://github.com/TelpromSecurity/AdminPanel)
**Comprehensive Flask Admin Panel with PostgreSQL Integration**
- 🔐 Secure authentication and user management
- 🌐 IP whitelist management with time-based expiration
- 📊 Real-time blacklist (RBL) API for Fortigate devices
- 🛡️ MFA and security token management
- 🐳 Docker support for easy deployment
- 📖 Complete documentation in Slovene and English

**Key Features:**
- Multi-application architecture (AdminPanel + RBL API + Whitelist)
